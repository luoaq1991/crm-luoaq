    ...
    <div class="easyui-accordion" data-options="fit:true,border:false">
       <#if userPermission?seq_contains('10')>
        <div title="营销管理" data-options="selected:true,iconCls:'icon-yxgl'" style="padding: 10px">
            ...
            <a href="javascript:openTab('营销机会管理','marketing/1/index.shtml','icon-yxjhgl')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-yxjhgl'" style="width: 150px">营销机会管理</a>
            </#if>
             <#if userPermission?seq_contains('1020')>
            <a href="javascript:openTab('客户开发计划','marketing/2/index.shtml','icon-khkfjh')" class="easyui-linkbutton"
        ...
        <div title="客户管理" data-options="iconCls:'icon-khgl'" style="padding:10px;">
            ...
            <a href="javascript:openTab('客户信息管理','customer/index.shtml','icon-khxxgl')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-khxxgl'" style="width: 150px;">客户信息管理</a>
             </#if>
             <#if userPermission?seq_contains('2020')>
            <a href="javascript:openTab('客户流失管理','customer_loss/index.shtml','icon-khlsgl')" class="easyui-linkbutton"
        ...
        <div title="服务管理" data-options="iconCls:'icon-fwgl'" style="padding:10px">
            <a href="javascript:openTab('服务创建','server/1/index.shtml','icon-fwcj')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-fwcj'" style="width: 150px;">服务创建</a>
            <a href="javascript:openTab('服务分配','server/2/index.shtml','icon-fwfp')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-fwfp'" style="width: 150px;">服务分配</a>
            <a href="javascript:openTab('服务处理','server/3/index.shtml','icon-fwcl')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-fwcl'" style="width: 150px;">服务处理</a>
            <a href="javascript:openTab('服务反馈','server/4/index.shtml','icon-fwfk')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-fwfk'" style="width: 150px;">服务反馈</a>
            <a href="javascript:openTab('服务归档','server/5/index.shtml','icon-fwgd')" class="easyui-linkbutton"
        ...
        <div title="统计报表" data-options="iconCls:'icon-tjbb'" style="padding:10px">
           <#if userPermission?seq_contains('4010')>
            ...
            <a href="javascript:openTab('客户流失分析','customer_loss/index.html','icon-khlsfx')" class="easyui-linkbutton"
        ...
        <div title="系统管理" data-options="iconCls:'icon-item'" style="padding:10px">
            ...
            <a href="javascript:openTab('用户信息管理','sysuser/index.shtml','icon-user')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-user'" style="width: 150px;">用户信息管理</a>
            <a href="javascript:openTab('角色管理','sysrole/index.shtml','icon-user')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-user'" style="width: 150px;">角色管理</a>
            <a href="javascript:openTab('模块管理','sysmodule/index.shtml','icon-user')" class="easyui-linkbutton"
